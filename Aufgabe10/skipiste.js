...
(function (SKIPISTE) {
    ...
    //Skifahrer
    movingObejcts.push(new SKIPISTE.SkiFahrer(250, 300, "#27b4df", (Math.random() * 2) + 1));
    movingObejcts.push(new SKIPISTE.SkiFahrer(300, 450, "#d84b20", (Math.random() * 2) + 1));
    movingObejcts.push(new SKIPISTE.SkiFahrer(450, 500, "#7fb0b2", (Math.random() * 2) + 1));
    movingObejcts.push(new SKIPISTE.SkiFahrer(500, 200, "#cf3476", (Math.random() * 2) + 1));
    movingObejcts.push(new SKIPISTE.SkiFahrer(290, 340, "#cf3476", (Math.random() * 2) + 1));
    movingObejcts.push(new SKIPISTE.SkiFahrer(450, 290, "#27b4df", (Math.random() * 2) + 1));
    movingObejcts.push(new SKIPISTE.SkiFahrer(290, 190, "#7fb0b2", (Math.random() * 2) + 1));
    movingObejcts.push(new SKIPISTE.SkiFahrer(560, 300, "#cf3476", (Math.random() * 2) + 1));
    //Sonne
